...
public class Ticket {
    ...
    /**
     * Provides a summary of the ticket information.
     *
     * @return A formatted string containing ticket ID, user ID, source, destination, and date of travel.
     */
    public String getTicketInfo() {
        // Formats and returns the ticket information as a string.
        return String.format("Ticket ID: %s belongs to User with ID: %s from %s to %s on %s", 
