...
public enum ResponseStatus {
    ...
    TICKET_NOT_CREATED(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to create ticket"),
    FREE_THE_SEAT_OPERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR,"Freeing the seats failed" ); // Indicates a failure in creating a ticket
